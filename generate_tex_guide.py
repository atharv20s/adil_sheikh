...
with open('thesis/figure_generation_guide.tex', 'w', encoding='utf-8') as f:
    ...
    for png in all_pngs:
        ...
        f.write('    \\centering\n')
        f.write(f'    \\includegraphics[width=0.75\\textwidth]{{../figures/{basename}}}\n')
        f.write('\\end{figure}\n')
        f.write('\\clearpage\n\n')
        
    f.write('\\end{document}\n')

print("Moved into thesis directory!")
