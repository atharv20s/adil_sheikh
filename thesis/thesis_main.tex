...
% Under the guidance of Prof. Adil Sheikh
...
\usepackage[
  ...
  urlcolor=ieee,
  bookmarks=true,
  pdfauthor={Athar Nakhuda, VJTI Mumbai},
...
% \includegraphics[width=3.5cm]{vjti_logo.png}\\[0.8cm]
...
\begin{tabular}{ll}
  ...
  \textbf{Affiliation:}& 3rd year B.Tech Undergrad at IIIT Nagpur \\[0.4cm]
...
\begin{center}
  ...
  \emph{Dedicated to my project guides,}\\
  \emph{Prof.\ Uday Suryavanshi and Dr.\ Sunny Kumar,}\\
  \emph{for their mentorship and professional support}\\
  \emph{during the course of this internship at VJTI Mumbai.}
\end{center}
...
First and foremost, I extend my deepest thanks to my project guides, \textbf{Prof. Uday Suryavanshi \& Dr. Sunny Kumar}, E-MC$^2$ Laboratory, Veermata Jijabai Technological Institute, Mumbai. Their exacting standards for analytical rigour, their insistence that every claim be traceable to a derivation, and their ability to distinguish between genuine contribution and academic fluff have fundamentally shaped both this thesis and my understanding of what research means. The framework in this work grew directly from hours of discussion, critique, and iterative revision under their direction.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{fig_10_methodology_pipeline.png}
    \caption{Research Methodology Pipeline detailing the four phases of thesis work.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig_1_architecture.png}
    \caption{Architectural comparison between a Reactive Centralized IDS and a Proactive Distributed BFT Blockchain.}
    \label{fig:ami_architecture}
\end{figure}
\clearpage
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig_8_blockchain_arch.png}
    \caption{BFT Blockchain Network Topology showing a Smart Meter submitting a transaction.}
    \label{fig:blockchain_topology}
\end{figure}
\clearpage

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{fig_2_protocol_flow.png}
    \caption{Protocol Sequence Flow showing the message exchange phases in the PBFT algorithm.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig_9_attack_graph.png}
    \caption{Twelve-Attack Threat Vector Graph mapping the progression of attack propagation paths.}
    \label{fig:attack_vector_graph}
\end{figure}
\clearpage

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{fig_6_spof_risk.png}
    \caption{SPOF Risk Plot demonstrating the Byzantine Failure Model versus a single point of failure.}
    \label{fig:spof_risk}
\end{figure}
\clearpage
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig_3_probability_tree.png}
    \caption{Probability Tree detailing the derivation of static and temporal vulnerability states.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{fig_5_poisson_timeline.png}
    \caption{Poisson Timeline visualizing the temporal vulnerability $P_{temporal} = 1 - e^{-\lambda L P_{TA}}$.}
    \label{fig:poisson_timeline}
\end{figure}
\clearpage
...
â”œâ”€â”€ protocols.json               <- Protocol performance metrics database
â”œâ”€â”€ probabilistic_model.py       <- Mathematical formulation engine
â”œâ”€â”€ run_experiments.py           <- Monte Carlo simulation executor
â”œâ”€â”€ generate_ieee_figures.py     <- Visualisation pipeline script
â”œâ”€â”€ figures/                     <- Target directory for generated plots
â”‚   â”œâ”€â”€ fig_sheikh_baseline_curve.png
â”‚   â”œâ”€â”€ fig_temporal_vulnerability.png
â”‚   â””â”€â”€ fig_architecture_comparison.png
â”œâ”€â”€ results/                     <- Output directory for simulation data
â”œâ”€â”€ paper/                       <- Source files for the IEEE Access paper
â””â”€â”€ thesis/                      <- Source files for this BTech thesis
    â”œâ”€â”€ thesis_main.tex          <- Master LaTeX file
    â”œâ”€â”€ frontmatter/             <- Front matter sections
    â”œâ”€â”€ chapters/                <- Chapter LaTeX documents
    â””â”€â”€ appendices/              <- Appendices with full code and data
\end{verbatim}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig_4_radar_comparison.png}
    \caption{Consensus Radar Comparison: Qualitative analysis between Reactive IDS, PBFT, Tower BFT, and RVR.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{fig_7_eta_sensitivity.png}
    \caption{Sensitivity to Spatial Validation Factor ($\eta$) demonstrating RVR's robustness.}
